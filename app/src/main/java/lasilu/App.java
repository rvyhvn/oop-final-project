...
// FXMLLoader(App.class.getResource("/lasilu/LoginView.fxml"));
...
// FXMLLoader(getClass().getResource("/lasilu/MainView.fxml"));
// Parent mainRoot = mainLoader.load();
// MainViewController mainController = mainLoader.getController();
// mainController.initData(); // Mengambil data siswa dan melakukan inisialisasi
// tampilan
